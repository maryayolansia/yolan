...
$update         = mysqli_query($conn, "UPDATE data_siswa SET id_siswa = '$id_siswa', nama_siswa = '$nama_siswa', nis_siswa = '$nis_siswa', alamat_siswa = '$alamat_siswa', notelp_siswa = '$notelp_siswa' WHERE id_siswa = '$id_siswa'");
